...
public class CargaDatos extends javax.swing.JFrame {
    ...
    mascotadto.setNombreMascota(txtNombre.getText());
    mascotadto.setRaza(txtRaza.getText());
    mascotadto.setColor(txtColor.getText());
    mascotadto.setObservaciones(txtObservaciones.getText());
    mascotadto.setNombreDuenio(txtNombreDuenio.getText());
    mascotadto.setCelDuenio(txtCelDuenio.getText());
    mascotadto.setAlergico((String) cmbAlegico.getSelectedItem());
    mascotadto.setAtencionEspecial((String) cmbAtEsp.getSelectedItem());

    //Validacion de campos para qeu no esten vacios
    if(mascotadto.getNombreMascota().isEmpty() || mascotadto.getNombreDuenio().isEmpty()){
        JOptionPane.showMessageDialog(this, "El nombre de la mascota o el dueño no puede ir vacio");
        return;}
            
     HttpCliente.crearMascota(mascotadto);
